...
q2.prepare("SELECT * FROM CLIENTS WHERE NOM='choix1'");
q2.exec();

q3.prepare("SELECT * FROM CLIENTS WHERE NOM='choix2'");
q3.exec();

q4.prepare("SELECT * FROM CLIENTS WHERE NOM='choix3' ");
q4.exec();
...
//pie chart
    ...
    // Define slices and percentNOM of whole they take up
